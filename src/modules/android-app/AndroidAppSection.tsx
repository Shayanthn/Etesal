        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-center">
          ...
          <div className="lg:col-span-7 space-y-6 text-right order-1 lg:order-2">
            ...
            <p className="text-sm text-slate-400 leading-relaxed max-w-xl">
              تجربه‌ای بدون افت سرعت و بدون نیاز به تنظیمات پیچیده. با یک کلیک به سالم‌ترین نودهای Reality و Hysteria 2 وصل شوید و از اینترنت آزاد لذت ببرید.
            </p>

            {/* Benefit Bullets */}
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 pt-2">
              {[
                { title: 'بای‌پس فایروال DPI', desc: 'تکنولوژی پیشرفته تکه‌تکه کردن بسته‌های TLS' },
