  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    if (editingTrack) {
      ...
      onShowToast({
        ...
        description: `ترک "${newTrack.title}" با کیفیت ۳۲۰ ذخیره و به پلی‌لیست افزوده شد.`,
        type: 'success'
      });
    }
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 p-4 rounded-2xl bg-slate-900 border border-slate-800">
        <div>
          <h3 className="text-sm font-bold text-white flex items-center gap-2">
            ...
            <span>هاب مدیریت و کتابخانه صوتی پیشرفته ({musicList.length} ترک صوتی)</span>
          </h3>
          <p className="text-xs text-slate-400 mt-1">
            آپلود موزیک، استخراج هوشمند تگ‌های ID3 و کاور، آنالیز فرکانسی و افزودن به رادیو و هاب صوتی پورتال.
          </p>
        </div>
        ...
        >
          ...
          <span>+ آپلود و افزودن موزیک جدید</span>
        </button>
      </div>
          ...
          return (
            ...
            >
              ...
              <div className="pt-3 border-t border-slate-800/80 flex items-center justify-between">
                <span className="px-2 py-0.5 rounded-md text-[10px] font-bold bg-purple-950/80 text-purple-300 border border-purple-500/30 flex items-center gap-1">
                  <Sparkles className="w-2.5 h-2.5 text-cyan-400" />
                  <span>کیفیت استودیو 320kbps</span>
                </span>
