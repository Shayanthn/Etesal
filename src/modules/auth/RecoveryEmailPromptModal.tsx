...
export const RecoveryEmailPromptModal: React.FC<RecoveryEmailPromptModalProps> = ({
  ...
  return (
    <div 
      className="fixed inset-0 z-[70] bg-slate-950/85 backdrop-blur-md flex items-center justify-center p-3 sm:p-4 md:p-6 animate-fade-in dir-rtl"
      onClick={onSkip}
    >
      <div 
        className="relative w-full max-w-[min(100%,26rem)] max-h-[92dvh] overflow-y-auto overscroll-contain bg-slate-900 border border-emerald-500/30 rounded-2xl sm:rounded-3xl p-4 sm:p-6 md:p-8 shadow-2xl shadow-emerald-950/40 my-auto"
